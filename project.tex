...
Intelligence (AI). We are proposing this innovative and
...
the world for observing, analyzing and evaluating the health of our
...
science, marine robotics, engineering, ocean modeling and
...
\kc{Wait for Pierre's contribution -- something here about the
  uniqueness of HOPS and potentially how it will interact with the
  observations.  That connection needs to be made clear for Keck.}
Shore-based machine intelligence will allow for statistical data
analysis from apriori data to capture expected seasonal variations for
...
Porto, with support from all team partners.
