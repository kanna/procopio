...
\item[Automated Data Pipeline, Quality Control \& Assimilation]
  ...
  Japanese satellites. % This task will require a software engineer with
  % requisite skills related to data understanding, databases, ocean
  % data formats.[SUGGEST DELETING THIS LAST SENTENCE - I.E NO MENTION
  % OF FTES IN THIS SECTION]
