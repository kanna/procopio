...
METEOR integrates the expertise from our team members, leading to unprecedented possibilities. The relocatable MIT-MSEAS modeling system provides unique capabilities in multiscale physical-biogeochemical-acoustical ocean modeling, probabilistic forecasting, data assimilation, and Bayesian inference. With its scientific machine learning and principled optimal path planning, MSEAS can guide fleets of AUVs, gliders, drifters, surface autonomous vehicles, UAVs and other aircrafts, and with METEOR, near space assets, towards the most informative observations.
